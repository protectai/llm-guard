...
from llm_guard.input_scanners import Anonymize, PromptInjection, TokenLimit, Toxicity,Language,Code,Sentiment
from llm_guard.output_scanners import Deanonymize, NoRefusal, Relevance, Sensitive,Bias,JSON,LanguageSame,MaliciousURLs,FactualConsistency,Regex,Relevance,Sensitive
...
sanitized_response_text, output_results_valid, output_results_score = scan_output(output_scanners,prompt,response.text,False)
